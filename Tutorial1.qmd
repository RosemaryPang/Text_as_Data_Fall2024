...
In this tutorial, you'll learn about working in R, how to get your R workspace set up, how to do some basic work with data in R, and we'll introduce a quick version of some (pretty though not necessarily useful) text analysis.
