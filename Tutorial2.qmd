...
harry_potter_corpus <- c(philosophers_stone_corpus, chamber_of_secrets_corpus,                prisoner_of_azkaban_corpus, goblet_of_fire_corpus,                    order_of_the_phoenix_corpus, half_blood_prince_corpus,                deathly_hallows_corpus)
...
```{r}
# list.files(): to list all files in a directory
